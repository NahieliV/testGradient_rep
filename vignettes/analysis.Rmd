---
title: "Analysis_of_survey_experiment"
output:
  html_document:
    toc: true
    toc_float: true
...
I would the client wants to boost the number of users that download the app, I would then recommend to:

-   set the price at \$20/month

-   choose as social proof a phrase that will make users think that the app is based on scientific evidence (like "leading researches" or "scientific evidence" )
